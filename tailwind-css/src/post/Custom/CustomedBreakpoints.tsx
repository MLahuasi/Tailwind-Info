...
export const CustomedBreakpoints = () => {
  return (
    <div className="mb-4">
      <div className="flex flex-col">
        <div className="text-orange-500 text-3xl m-1">@theme (breakpoint)</div>
        <div className="bg-principal-pagina h-[40vh] relative overflow-hidden">
          <nav
            className="
            py-8 border-2 border-borde-pagina 
            md:bg-green-500
            custom-bp-800:bg-blue-500"
          >
